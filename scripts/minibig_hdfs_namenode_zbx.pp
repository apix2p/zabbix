...
import minibig_jmx_hdfs_namenode_def as mjhdfsnn
...
def main():
	...
	mjhdfsnn.get_rpc(jsonbeansdata,server,epoch_time)
	mjhdfsnn.get_nn_ugi(jsonbeansdata,server,epoch_time)
	mjhdfsnn.get_fsnamesys(jsonbeansdata,server,epoch_time)
	mjhdfsnn.get_retrycache(jsonbeansdata,server,epoch_time)
