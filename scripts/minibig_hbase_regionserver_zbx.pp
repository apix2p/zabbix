...
import minibig_jmx_hbase as mjhbase
import minibig_jmx_hbase_rs_def as mjhbrs
import minibig_jmx_jvm_cms as mjjcms
...
def main():
	...
	mjhbrs.get_replication(jsonbeansdata,server,epoch_time)
	mjhbrs.get_wal(jsonbeansdata,server,epoch_time)
	mjhbrs.get_regionserver(jsonbeansdata,server,epoch_time)
